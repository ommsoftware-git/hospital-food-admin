(function ($) {
  ...
  $(function () {
    ...
    if ($(".navbar").hasClass("fixed-top")) {
      ...
      document.querySelector(".navbar").classList.remove("pt-0");
    } else {
      document.querySelector(".page-body-wrapper").classList.add("pt-0");
      document.querySelector(".navbar").classList.add("pt-0");
      document.querySelector(".navbar").classList.add("mt-0");
    }
    document
      ...
      .addEventListener("click", function () {
        ...
        $.cookie("connectplus-free-banner", "true", {
          expires: date,
        });
      });
  });
